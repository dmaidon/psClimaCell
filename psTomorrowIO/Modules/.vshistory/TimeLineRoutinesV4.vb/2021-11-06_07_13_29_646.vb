...
Friend Module TimeLineRoutinesV4
    ...
    Private Function GetFloodIndex(val As Integer) As String
        Dim FlFldArr As New List(Of String)({"Minor flash flooding possible", " Moderate flash flooding possible", " Significant flash flooding possible", "Major river and/or flash flooding possible", "Catastrophic or extreme river and/or flash flooding probable or likely"})
        Return FlFldArr(val)
    End Function
    ...
    Private Sub WriteData(ctl As DataGridView, ct As Integer, j As Integer)
        ...
        With ctl
            ...
            If tl.RainAccumulation IsNot Nothing AndAlso tl.RainAccumulation.HasValue Then
                .Rows.Add("Rain Accumulation", $"{tl.RainAccumulation.Value:N3} {unitNfo.RainAccumulation}")
            End If
